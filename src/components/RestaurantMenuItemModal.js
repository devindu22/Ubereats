...
const RestaurantMenuItemModal = ({ itemName, price, backgroundImage, handleModalOpen, modalIsOpen }) => {
    ...
    return (
        <>
            <Modal centered keyboard show={modalIsOpen} onHide={handleModalOpen}>
                <Modal.Header style={{ height: "30vh", backgroundImage: `url(${order})`, backgroundSize: "cover" }} closeButton className="border-0">
                </Modal.Header>
